...
20181029 - with respect to item 3 above, this seems to cause me to need to bring in this random old timeseries_et file. can I just take the CoP data from there and paste it into the CoP met data?
need to notate new data source for precip - used to be godo year but now 
20181030 - THIS HAS BEEN FIXED! Eliminated the need for "timeseries_et", can now just use met station file for all ET calcs
