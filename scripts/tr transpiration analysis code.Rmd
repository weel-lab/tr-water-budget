...
goodyear_daily_precip <- read.csv('/Volumes/GoogleDrive/My Drive/weel/tres rios/datasets/tr-water-budget/data/goodyear_met_jul2011_sep2017.csv')
...
hourly_ET <- read.csv('/Volumes/GoogleDrive/My Drive/weel/tres rios/datasets/tr-water-budget/data/time_series_et.csv', stringsAsFactors = FALSE)
